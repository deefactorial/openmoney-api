...
ROOT_CURRENCY=${9:-cc}
#
#export variables so that they are accessable to child node processes
export COUCHBASE_ADMIN_USERNAME=$COUCHBASE_ADMIN_USERNAME
export COUCHBASE_ADMIN_PASSWORD=$COUCHBASE_ADMIN_PASSWORD
export COUCHBASE_IP=$COUCHBASE_IP
export COUCHBASE_LO=$COUCHBASE_LO
export ADMIN_USERNAME=$ADMIN_USERNAME
export ADMIN_PASSWORD=$ADMIN_PASSWORD
export ADMIN_EMAIL=$ADMIN_EMAIL
export ROOT_SPACE=$ROOT_SPACE
export ROOT_CURRENCY=$ROOT_CURRENCY
#
#output the status of script variables so you know what your values are
echo COUCHBASE_ADMIN_USERNAME=$COUCHBASE_ADMIN_USERNAME
echo COUCHBASE_ADMIN_PASSWORD=$COUCHBASE_ADMIN_PASSWORD
echo COUCHBASE_IP=$COUCHBASE_IP
echo COUCHBASE_LO=$COUCHBASE_LO
echo ADMIN_USERNAME=$ADMIN_USERNAME
echo ADMIN_PASSWORD=$ADMIN_PASSWORD
echo ADMIN_EMAIL=$ADMIN_EMAIL
echo ROOT_SPACE=$ROOT_SPACE
echo ROOT_CURRENCY=$ROOT_CURRENCY
#
#install dependency applications
sudo apt-get update
sudo apt-get install -y npm net-tools docker curl
